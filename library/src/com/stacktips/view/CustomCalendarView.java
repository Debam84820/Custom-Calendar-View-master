...
public class CustomCalendarView extends LinearLayout {
    ...
    private void initializeCalendar() {
        ...
        previousMonthButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                currentMonthIndex--;
                Log.e("currentMonthIndex", String.valueOf(currentMonthIndex));
    ...
    private void setDaysInCalendar() {
        ...
        for (int i = 1; i < 43; i++) {
            ...
            Log.e("DAY_OF_MONTH_TEXT", DAY_OF_MONTH_TEXT + i);
            if (dayView == null)
                continue;
    ...
    private OnClickListener onDayOfMonthClickListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            calendar.setFirstDayOfWeek(getFirstDayOfWeek());
            calendar.setTime(currentCalendar.getTime());
            String[] dayOfMonth = dayOfMonthText.getText().toString().split("\n");
            calendar.set(Calendar.DAY_OF_MONTH, Integer.parseInt(dayOfMonth[0]));
